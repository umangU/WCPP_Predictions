...
wcpp <- read.csv('C:/Documents/Codes/R/World Article Count/WCPP_Article_count.csv', header = TRUE)
...
for (i in 2:ncol(wcpp))
{
  ...
  Y <- window(subset_data_ts, start=c(2020, 1), end=c(2020, 6))
  y <- log10(Y)
...
predictions
write.csv(predictions, "C:/Documents/Codes/R/World Article Count/WCPP_ERA2023_Article_Count_Predictions.csv")